...
**Intuition:**
If you borrow \$10,000 at a discount rate $d$, the lender gives you less than \$10,000 today, but you pay back exactly \$10,000. The "interest" is pre-paid (deducted) at the start.
...
**Interpretation:**
If the 10-year Treasury yields 4.0% and the 10-year TIPS yields 2.5%, the market expects average inflation to be roughly $4.0 - 2.5 = 1.5\%$ over the next decade .
